...
async function loadConfig() {
    try {
        ...
        if (data.success) {
            ...
            // Stats
            document.getElementById('stat-e1').textContent = cfg.count_E1 ?? '--';
            document.getElementById('stat-f1').textContent = cfg.count_F1 ?? '--';
            document.getElementById('stat-e2').textContent = cfg.count_E2 ?? '--';
            document.getElementById('stat-f2').textContent = cfg.count_F2 ?? '--';
            document.getElementById('stat-g1').textContent = cfg.count_G1 ?? '--';
            document.getElementById('stat-g9').textContent = cfg.count_G9 ?? '--';
        }
    } catch (err) {
